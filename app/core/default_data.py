...
groups_list = ["kekajangroup", "adaptaciyausa", "adaptaciya_ua_usa", "ads_new_york", "calosangeles", "ca_miami_chat",
               ...
               "los_angeles_california_usa", "miamichatik", "miamichatru", "movingsf", "multinational_group",
               "nashaphiladelphia", "nashlosangeles", "nashmiami", "nashny", "newyorkchatru", "nyjobsusa",
               "philadelphiachat", "phillychat", "russianlo", "sacramentocity", "telemarketus", "ukrnewyorkgroup",
               "usachatru", "usaforuz", "usagreen", "usarmenians", "usa_360", "usb_mexico_usa", "uzbeksinusalup",
               "vatandoshimuzbus", "vatandoshim_usa_50_state", "vatandoshim_uz", "vatandoshimusa", "yagonadarchausany",
               "nomadsfamilyusa", "kg_america", "nashchicago", "nomadschicago", "sfnomad", "mahallanewyorkjobs",
               "nomadssd", "mexicousa21", "newyorknash1", "rentcarnomad", "rusoenmexico", "workersnomads",
               "ads_california", "america_new_york", "canada_work_life", "creditmebel908203131", "dogbanusa",
               "freeshipping", "horizont24", "housingnomad", "jobinmoving", "jobs_usa24", "jobsinny", "la_california",
               "liveintheusa", "mextous", "miamihotchat", "nomadsboston", "nomadsmiami", "nomadsdc", "nomadsfamily",
               "poputchiki_usa", "rent_miami_rusrek", "russianclassifieds", "teachbkusa", "trucker_cargo",
               "usa_benefit", "usa_exchange", "usa_job_help", "usa_job_helper", "usamexico", "used21cars",
               "biznesdvigusa", "miamiarea", "newyorkchat24", "newyork_job", "vhi7f", "mayami_360", "nomadsfamilyla",
               "nyjobs_usa", "in_miami"]

proxies_list = [
    # "zrZ1na:vzSPV8@38.170.95.174:9504", "zrZ1na:vzSPV8@38.153.57.132:9851", "zrZna:vzSPV8@38.12.57.11:9851",
    ...
    # "UL9T4ywA:jZU9csXZ@91.232.9.237:62969", "UL9T4ywA:jZU9csXZ@78.136.249.25:63195",
    # "country-id:ccddd936-1cc0-4922-9a6c-e6bf5dfe84bd@proxy.proxyverse.io:9200"
]

sessions_list = {
    "6281998462576": {
        "phone": "6281998462576", "user_id": 5770351267,
        "string_session": "BQGqPjAAWkk36PimsyR8FIxZ3ZjE0bPWEmjp1wbHm23jTt4GJJH5vGguSgzZgum8a9KSHFhrhoxRP72pmj1Xj_gKgAvH97QOyClDVhUGnemFlMg6mubYo3dz6rQOY0h8kj4lTGkuvRahDSRySj0hR0-qT8gfycaYHsd7IeNVklVFmcrPUujek86k3ABDCun6Y6yIrwAse2uALRyn04RGZyNe2Ge2nve-a15wDr3F_lgHtW51x60YPUNOR16w78usgXo4M27Pf1hAsCt61764fXRJ5D8VaEk4WOuM7aVxdRAbN-q_K2WHtKJkZuB9geolXJj7CDJlMx4YrvM0-5-VvQARtTB08wAAAAFX8JKjAA",
        "api_id": 27934256, "api_hash": "28d26a415658ed1d96ccdda6142a7877", "device_model": "PC 64bit",
